USING: accessors aoc.input arrays ascii assocs assocs.extras
combinators.short-circuit grouping kernel math
math.combinatorics math.matrices math.order math.vectors
